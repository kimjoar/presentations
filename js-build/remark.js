...
api.on('next', function() {
  events.emit('gotoNextSlide');
});

api.on('prev', function() {
  events.emit('gotoPreviousSlide');
});

api.on('slide', function(slide) {
  events.emit('gotoSlide', slide);
});
...
require.define("/src/remark/views/overlayView.js",function(require,module,exports,__dirname,__filename,process,global){var events = require('../events')
  , resources = require('../resources')
  ;
